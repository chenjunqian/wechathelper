...
SECRET_KEY = '2zft0r4b0suc%bi3+hd8x09z_j5-m&qog+%$p_fb=v7g-#zlf8'
...
LOGGING = {
    ...
    'handlers': {
        ...
        'default': {
            ...
            'filename': '/home/project/djangosite/log/django.log',     
    ...
    'loggers': {
        ...
        'djangosite.wechathelper.servive': {
            'handlers': ['default', 'error'],
            'level': 'DEBUG',
            'propagate': True
        },
        'djangosite.wechathelper.views':{
            'handlers': ['error'],
            'level': 'ERROR',
            'propagate': True
        }
